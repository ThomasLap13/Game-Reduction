...
<head>
    <title>Discord - Game Réduction</title>
</head>

<main>
    <div id="Nitro-Boost" class="category-section">
        <div style="min-height: 30px;"></div>
        <div class="container category-content hidden text-center">
            <h1 class="text-center fade-in">Nitro</h1>
            <hr>
            <h2 class="text-start fade-in">Nitro Boost</h2>
    ...
    <div id="Nitro-Basic" class="category-section">
        <div style="min-height: 130px;"></div>
        <div class="container category-content hidden text-center">
            <h2 class="text-start fade-in">Nitro Basic</h2>
    ...
    <div id="Décorations&Boost" class="category-section">
        <div style="min-height: 130px;"></div>
        <div class="container category-content hidden text-center">
            <h1 class="text-center fade-in">Décorations et Boost</h1>
            <hr>
            <h2 class="text-start fade-in hidden">On a encore ça pour vous !</h2>
            <div class="row justify-content-center">
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
