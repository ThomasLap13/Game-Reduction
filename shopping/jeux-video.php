...
<main>
    <div id="Epic-Games" class="category-section">
        <div style="min-height: 30px;"></div>
        <div class="container category-content hidden text-center">
            <h1 class="text-center fade-in">Epic Games</h1>
            <hr>
            <h2 class="text-start fade-in">Fortnite</h2>
            <div class="row justify-content-center">
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/epicgame/pass.jpg" class="card-img-top" alt="Pass de combat">
                        <div class="card-body">
                ...
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/epicgame/Club-Fortnite-temp.png" class="card-img-top" alt="Club de Fortnite">
                        <div class="card-body">
                            <h5 class="card-title">Le Club - Fortnite<br>1 Mois</h5><br>
                            <p class="card-text">Passe de combat, du Passe OG, du Passe LEGO et du Passe Musique. Ils obtiennent également 1 000 V-bucks et des objets spéciaux tous les mois.</p><br>
                            <h5><s>11,99€</s> - 9,49€</h5>
                ...
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/epicgame/V-Bucks.png" class="card-img-top" alt="V-Bucks">
                        <div class="card-body">
    ...
    <div id="Brawl-Stars" class="category-section">
        <div style="min-height: 130px;"></div>
        <div class="container category-content hidden text-center">
            <h1 class="text-left fade-in">Supercell</h1>
            <hr>
            <h2 class="text-start fade-in">Brawl Stars</h2>
    
            <!-- Première ligne de cartes -->
            <div class="row justify-content-center mb-4">
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/supercell/BS-Pass-Pro.jpg" class="card-img-top" alt="Pass Brawl">
                        <div class="card-body">
                ...
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/supercell/BS-Pass-Diams.jpg" class="card-img-top" alt="Pass Brawl Plus">
                        <div class="card-body">
                ...
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/supercell/BS-Pass-Gold.jpg" class="card-img-top" alt="Pass Brawl Gold">
                        <div class="card-body">
            ...
            <div class="row justify-content-center">
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/supercell/BS-Ressources.jpg" class="card-img-top" alt="Ressources">
                        <div class="card-body">
                ...
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/supercell/BS-Offre-Demande.png" class="card-img-top" alt="Offres Spéciales">
                        <div class="card-body">
    ...
    <div id="Clash-of-Clans" class="category-section">
        ...
        <div class="container category-content hidden text-center">
            ...
            <div class="row justify-content-center mb-4">
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/supercell/CC-Pass-Event.jpg" class="card-img-top" alt="Produit">
                        <div class="card-body">
                ...
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/supercell/CC-Pass-Gold.jpg" class="card-img-top" alt="Produit">
                        <div class="card-body">
                ...
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/supercell/BS-Ressources.jpg" class="card-img-top" alt="Produit">
                        <div class="card-body">
    ...
    <div id="Clash-Royale" class="category-section">
        ...
        <div class="container category-content hidden text-center">
            ...
            <div class="row justify-content-center mb-4">
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/supercell/CR-Pass-Diams.jpg" class="card-img-top" alt="Produit">
                        <div class="card-body">
    ...
    <div id="Nintendo" class="category-section">
        ...
        <div class="container category-content hidden text-center">
            ...
            <hr>
            <h2 class="text-start fade-in">Nintendo Online</h2>
            <div class="row justify-content-center">
                <div class="col-md-4 fade-in hidden">
                    <div class="card">
                        <img src="../assets/images/products/nintendo/online.png" class="card-img-top" alt="Produit">
                        <div class="card-body">
